...
export const useAnythingLLMClausen = () => {
  useEffect(() => {
    // Check if script is already loaded
    if (document.querySelector('[data-embed-id="11febadd-7a80-4c4f-aabc-285e9c340646"]')) {
      return;
    }

    const script = document.createElement('script');
    script.setAttribute('data-embed-id', '11febadd-7a80-4c4f-aabc-285e9c340646');
    ...
    style.textContent = `
      /* Professional theme-adaptive styling for Clausen */
    ...
    return () => {
      const existingScript = document.querySelector('[data-embed-id="11febadd-7a80-4c4f-aabc-285e9c340646"]');
      if (existingScript) {
