...
const navGroups: NavGroup[] = [
  ...
  {
    name: 'Strategic Insights Suite',
    items: [
      {
        name: 'Keystone Presentation Engine',
  ...
  {
    name: 'Go-to-Market & Commercial Execution Toolkit',
    items: [
      {
        name: 'ICP Builder',
        id: 'icp_builder',
